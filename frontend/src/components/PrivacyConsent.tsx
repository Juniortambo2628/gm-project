      ...
      <div className="fixed bottom-0 left-0 w-full p-4 md:p-8 z-[90] flex justify-center pointer-events-none animate-in slide-in-from-bottom-10 duration-700">
        <div className="bg-card/95 backdrop-blur-2xl border border-border rounded-[40px] p-6 md:p-8 w-full max-w-5xl flex flex-col md:flex-row items-center gap-8 shadow-2xl pointer-events-auto ring-1 ring-slate-900/5 transition-colors duration-300">
          ...
          <div className="flex items-start gap-5">
            <IconBlock icon={Shield} className="bg-primary/10 text-primary border-none p-4 w-14 h-14" />
            <div className="flex-1">
               <h3 className="text-xl text-foreground mb-1 italic">Privacy calibration</h3>
               <p className="text-muted-foreground text-xs md:text-sm leading-relaxed font-bold max-w-xl">
                  We use cookies and analytics to optimize your experience. 
                  By accepting, you allow us to improve our services through anonymized data.
               </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 w-full md:w-auto mt-6 md:mt-0">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <Button 
                  ...
                  className="flex-1 md:flex-none h-14 px-8 border-2 border-border text-muted-foreground rounded-2xl text-[13px] font-bold hover:bg-secondary transition-all"
              >
                  Opt out
              </Button>
              ...
              <Button 
                  ...
                  className="flex-1 md:flex-none h-14 px-10 bg-primary hover:bg-primary/90 text-primary-foreground rounded-2xl text-[13px] font-bold shadow-xl shadow-primary/20 transition-all active:scale-95 border-none"
              >
                  Authorize all
              </Button>
            </div>
          ...
          <div className="space-y-4">
              {/* Essential */}
               <div className="p-6 bg-slate-50 dark:bg-slate-950 rounded-[32px] border border-slate-100 dark:border-slate-900 flex items-start gap-4 transition-all">
                 <IconBlock icon={Lock} className="p-3 bg-white dark:bg-slate-900 text-primary border-none shadow-sm" />
                 <div className="flex-1">
                   <div className="flex items-center justify-between mb-1">
                     <h4 className="text-xs text-slate-900 dark:text-white font-bold">Essential nodes</h4>
                     <span className="text-[13px] font-bold text-primary px-2 py-1 bg-primary/10 rounded-md">Required</span>
                   </div>
               ...
               <div className="p-6 bg-slate-50 dark:bg-slate-950 rounded-[32px] border border-slate-100 dark:border-slate-900 flex items-start gap-4 group transition-all">
                 <IconBlock icon={BarChart3} className="p-3 bg-white dark:bg-slate-900 text-emerald-500 border-none shadow-sm" />
                 <div className="flex-1">
                   <div className="flex items-center justify-between mb-1">
                     <h4 className="text-xs text-slate-900 dark:text-white font-bold">Behavioral analytics</h4>
                     <button 
               ...
               {/* Marketing */}
               <div className="p-6 bg-slate-50 dark:bg-slate-950 rounded-[32px] border border-slate-100 dark:border-slate-900 flex items-start gap-4 group transition-all">
                 <IconBlock icon={Target} className="p-3 bg-white dark:bg-slate-900 text-amber-500 border-none shadow-sm" />
                 <div className="flex-1">
                   <div className="flex items-center justify-between mb-1">
                     <h4 className="text-xs text-slate-900 dark:text-white font-bold">Marketing and reach</h4>
                     <button 
            ...
            <div className="flex items-center gap-4 w-full sm:w-auto">
                ...
                >
                 ...
                 <Button 
                   ...
                   className="w-full sm:w-auto h-14 px-10 bg-primary hover:bg-primary/90 text-white rounded-2xl text-xs shadow-xl shadow-primary/20 active:scale-95 transition-all font-bold"
                 >
                   Save configuration
                 </Button>
            </div>
