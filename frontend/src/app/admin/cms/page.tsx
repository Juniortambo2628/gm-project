...
function BrandingModule({ localSettings, setLocalSettings, saving, setSaving }: ModuleProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full">
...
function HeroModule({ localSettings, setLocalSettings, saving, setSaving }: ModuleProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full">
      <div className="space-y-6">
