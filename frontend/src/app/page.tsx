...
export default function Home() {
  ...
  const heroBackground = settings['hero_background_path'] || '/landing-hero-bg-image-landscape.png';
  ...
  return (
    <main className="relative min-h-screen flex flex-col overflow-hidden antialiased bg-background text-foreground transition-colors duration-300">
      <div className="relative flex flex-col w-full min-h-[70vh] overflow-hidden">
        {/* Dynamic Background - now restricted to this container */}
        ...
        <section className="relative z-10 flex-1 flex flex-col justify-center px-5 pt-32 pb-20">
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 items-center gap-12">
            ...
            <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
              <div className="w-full h-12 flex items-center justify-center lg:justify-start border border-white/10 bg-primary/10 dark:bg-primary/20 backdrop-blur-md rounded-full px-8 shadow-xl transition-all animate-fade-in shadow-white/5">
              ...
              <div className="w-full backdrop-blur-md bg-white/5 dark:bg-[#470f0b]/20 rounded-[40px] p-8 md:p-10 border border-white/10 shadow-2xl space-y-8 animate-slide-up relative">
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 w-full pt-4">
                  <div className="group relative p-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl hover:bg-primary/20 transition-all duration-500 shadow-2xl">
      ...
      {/* Hey, I'm Gathoni Bio Section (Salvaged from About Page) */}
      <section id="bio" className="relative z-10 py-24 bg-secondary/5 border-y border-border overflow-hidden">
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative border-l-4 border-primary pl-8 md:pl-12 space-y-8">
              ...
              {settings['about_bio_full'] ? (
                settings['about_bio_full'].split('\n\n').map((para: string, i: number) => {
                  if (para.includes("\"") || para.includes("honesty truth")) {
                    return (
                      <div key={i} className="p-8 md:p-10 bg-card rounded-3xl border border-border shadow-xl transform -rotate-1 my-10">
      ...
      {/* Credentials Grid (Salvaged from About Page) */}
      ...
      {/* Why an African Coach Section */}
      <section className="relative z-10 py-20 bg-background transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-6">
      ...
      <section className="py-20 relative z-10 px-6">
         <div className="max-w-4xl mx-auto rounded-3xl bg-primary text-white p-10 md:p-16 text-center shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]" />
             ...
             <Link href="/book">
                <Button className="bg-white text-primary hover:bg-white/90 px-12 h-14 text-lg font-bold rounded-full group">
                   Book free discovery call <ArrowRight className="ml-3 group-hover:translate-x-2 transition-transform" />
                </Button>
             </Link>
         </div>
      </section>
