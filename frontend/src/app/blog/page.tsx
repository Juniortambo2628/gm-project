...
export default function BlogListingPage() {
  const { blog_posts } = useCMSContent();
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mt-32 p-10 lg:p-20 bg-primary text-white rounded-3xl relative overflow-hidden shadow-3xl">
           ...
           <div className="relative z-10 max-w-3xl">
              <h2 className="text-3xl lg:text-4xl font-bold mb-8 italic">&ldquo;Empowering the next generation of African leaders is not just a mission, it&apos;s a responsibility.&rdquo;</h2>
              <div className="flex items-center gap-6">
                 <div className="w-14 h-14 rounded-2xl overflow-hidden border-2 border-white/20 relative">
                     <Image src="/about-professional-portrait-red-bg.png" alt="Gathoni" fill sizes="56px" className="object-cover" />
                 </div>
                 <div>
